...
<p float="center">
    ...
    <img src="Images/arrow.png" width="6%" height="100%"> 
...
consists of 4275 images. Some images have multiple faces and some of them only have only a person on it.
...
In [First notebook](./part1_face_boundary_detection.ipynb) I trained a vgg16 model with imagenet weight and only two trainable layers. This model gets resized images of areas in images that selective search algorithm picked, then classify those resized part into non-face and face categories.

Also in this notebook I trained data with customized fit function. 
